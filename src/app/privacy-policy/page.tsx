  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <Paragraph>
        ...
        зміни, пов'язані з вашою заявкою, а також розсилки повідомлень про події
        в компанії події та зміни, важливої ​​інформації про нові товари і
      ...
      <Paragraph>
        ...
        файл «cookie» зчитується з комп'ютера. Один з напрямків використання
        файлів «cookie» пов'язане з тим, що з їх допомогою полегшується збір
        статистики відвідування. Ці відомості допомагають визначати, яка
        інформація, що відправляється замовникам, може представляти для них
        найбільший інтерес. Збір цих даних здійснюється в узагальненому вигляді
        і ніколи не співвідноситься з особистими відомостями користувачів.
      </Paragraph>
      <Paragraph>
